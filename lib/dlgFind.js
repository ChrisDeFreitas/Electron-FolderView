...
function dlgFindCreate(controlId) {
	...
	html =`
		...
		<label class="divBulkOptions" style='color:##ffaf00; display:block; margin:0 auto; width:70%;'>Find:	<input id='${findId}' value='${find}' style="width:80%; " onclick="this.select()" spellcheck=false autocorrect=off ></label>
		...
		<div id=divFindOpts style="margin:0 auto; width:80%">
			...
			<label><input type=checkbox id=findRegex findRegex> Find string is a <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions" title='Goto MDN Regular Expressions' target=_new>regex</a> 
				<button id=btnReExamples onclick="this.parentNode.parentNode.querySelector('#divReExamples').style.height='auto'" style="font-size:0.8em; margin-left: 1em;">Examples</button>
