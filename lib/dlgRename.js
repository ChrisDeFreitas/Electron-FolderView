	...
	dlgRename = dlgFactory.create({	//rename dlg
		...
		body: `<style>
					...
					<label style="display:block;margin:0.5em 0 0.5em 0">
						New name<br>
					 	<textarea id=inpRNNew isContentEditable=true onclick="ui.var.dlgRenameEd=this;" type=text style='font-family:Arial; text-align:left; width:44.7em;' tabindex=0 autocomplete=off spellcheck=false >${fnnew}</textarea>
					</label>
