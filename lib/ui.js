...
//	dlgIdxMinItems:10,	//minimum number of folder items to display in item index
	...
	videoDlDefaultItags:'137, 136, 22, 251, 171, 140',		//comma delimited string
	videoDlClean:true,
}
...
function gridLoad(layoutMode, extFilter){
	...
	if(ui.args.defaultImageName != null){
		...
		if(ui.args.path.indexOf(ui.args.defaultImageName) >= 0)
			...
			selectedFile=path.posix.join(ui.args.path, ui.args.defaultImageName)
	}
...
//	}
	...
	if(selectedFile != null || itemselected != null){	//may be changing layout, list is unchanged
		...
		if(itemselected !=null ){
			...
			if(ui.args.defaultImageName != null && ui.args.defaultImageName == selectedFile){		//open image from commandline args
