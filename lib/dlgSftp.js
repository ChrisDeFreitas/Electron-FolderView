...
function dlgSFTP(){
	...
	this.initCtrls = function(){
		...
		//confiugre auto delete button's hover menu
...
dlgSFTP.autoClick = function(event){
	...
	//console.log( 'lblDel',	pnl.querySelector('#lblDel input').checked )
	//console.log( 'lblClose', pnl.querySelector('#lblClose input').checked )
	...
	dlgsftp.autoAfterDownload = function(){
		...
		/*if(pnl.querySelector('#lblDel input').checked === true){
		}
		if(pnl.querySelector('#lblClose input').checked === true){
			dlgFactory.bbl('Auto: closing dialog after download.')
			dlgFactory.close(dlg)
		}*/
		dlgFactory.bbl('Auto: done.')
		dlgsftp.auto = false
	...
	if(pnl.querySelector('#lblCon input').checked === true){
		dlgsftp.auto = true
		dlgsftp.connect()		// dlgsftp.remoteShow() will call dlgsftp.autoAfterLoad
	} else
	if(dlgsftp.connected){
		dlgsftp.auto = true
		dlgsftp.autoAfterLoad()
	}else
