...
var videoWall = {
	...
	btnApplyClick: function(){
		...
		if(dlgVideoWall != null){
			...
			dlgVideoWall.querySelector('.spQueNextIdx1').innerHTML = Number(this.tiles[0].dataset.vwidx) +1
			dlgVideoWall.querySelector('.spQueNextIdx2').innerHTML = Number(this.tiles[ this.tiles.length -1].dataset.vwidx) +1
		}
	},
	...
	tilesNext: async function(){	//play next group of tiles
		...
		if(dlgVideoWall != null) {		//update ui
			dlgVideoWall.querySelector('.spQueNextIdx1').innerHTML = Number(this.tiles[0].dataset.vwidx) +1
			dlgVideoWall.querySelector('.spQueNextIdx2').innerHTML = Number(this.tiles[ this.tiles.length -1].dataset.vwidx) +1
		}
		if(playing === true)
...
videoWall.drawDlg = function(){
	let spQueNextIdx1 = '',	spQueNextIdx2 = ''

	if(this.tiles.length > 0){
		spQueNextIdx1 = Number(this.tiles[0].dataset.vwidx) +1
		spQueNextIdx2 = Number(this.tiles[ this.tiles.length -1].dataset.vwidx) +1
	}
	...
	let	tbhtml = `<div id=toolbar>
				...
				<div class=toolCtrls>
					...
					#<span class=spQueNextIdx1>${spQueNextIdx1}</span> to <span class=spQueNextIdx2>${spQueNextIdx2}</span>
