	  ...
	  for(let sub of subs){
		...
		if(tmp != ''){
			...
			result += `
				...
				<table id="${tbid}"><tr>
					<td onclick="gridSort('${tbid}', 4, 1, false)">Folder</td>
					<td onclick="gridSort('${tbid}', 1, 1, true)">Items</td>
					<td onclick="gridSort('${tbid}', 2, 1, true)">&nbsp;Total Items</td>
					<td onclick="gridSort('${tbid}', 5, 1, true)">&nbsp;Total Size</td>
				</tr>
				${tmp}
				</table>
