	...
	var template = [
	  {
	    ...
	    submenu: [
			...
			submenu: [
				{ label: 'Descending', type:'checkbox',  checked:false, accelerator:'Alt+Shift+D',
					click: function(item, win, ev) {
