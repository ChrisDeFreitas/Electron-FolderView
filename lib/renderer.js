	...
	*/
	...
	,	onSelect: function(dir){
			var oldpath = ui.calc.pathForOS( obj.path),
					newpath = ui.calc.pathForOS( path.resolve( dir, path.basename(obj.path) ) )
...
function bulkOps(pid){
	...
	if(ui.var.dlgBulkDest==null) ui.var.dlgBulkDest = ''
	let buttons = {
	...
	dlgBulk = dlgFactory.create({
		...
		body: `
			...
			<div class=divBulkOptions> Select: </div>
			<div id=divBulkList>
				${list}
			</div>
			`,
